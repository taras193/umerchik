...
if (isMobile == true) {
  $('.animation,.animation2,.animation3,.animation4').addClass('animated');
  $('<style>.animation,.animation2,.animation3,.animation4 *{opacity:1;top:0;transition:0s all 0s!important;animation-duration:0s!important;animation-delay:0s!important}.site-nav.down,.site-nav.up{display:none!important}section{height:800px!important}.header-head p{float:left!important;display:block!important;margin: 45px 7% 0px;}.logo{float:left!important;display:block!important;}.phone{float:left!important;display:block!important;}</style>').appendTo('head');
}
...
setTimeout(function(){
  ...
  //форма
  $('.clik12').click(function(e) {
    e.preventDefault();
    $('#f_n2').addClass('active');
    $('#f_n1').removeClass('active');
  });
  $('.next3').click(function(e) {
    e.preventDefault();
    $('#f_n3').addClass('active');
    $('#f_n2').removeClass('active');
  });
  $('.next4').click(function(e) {
    e.preventDefault();
    $('#f_n4').addClass('active');
    $('#f_n3').removeClass('active');
  });
  $('.clik3').click(function(e) {
    e.preventDefault();
    $('#f_n5').addClass('active');
    $('#f_n1').removeClass('active');
  });
  $('.next6').click(function(e) {
    e.preventDefault();
    $('#f_n6').addClass('active');
    $('#f_n5').removeClass('active');
  });
  $('.next7').click(function(e) {
    e.preventDefault();    
  if ($('.slde_n').hasClass('active')) {    
    $('#f_n4').addClass('active');
    $('#f_n6').removeClass('active');
  }
  });
  $('.next71').click(function(e) {
    e.preventDefault();     
    $('#f_n4').addClass('active');
    $('#f_n6').removeClass('active');
  });
  $('.back').click(function(e) {
    e.preventDefault();
    $('#f_n2,#f_n3,#f_n4,#f_n5,#f_n6').removeClass('active');
    $('#f_n1').addClass('active');  
  });
  $('.slde_n').click(function() {
    $('.slde_n').removeClass('active');
    $(this).addClass('active');
    $('.btn_n3').removeClass('silver');
  });
...
$('.popap .close, .clos').click(function(e){
    e.preventDefault();
...
slider3 = $('#sldn').bxSlider({pager:false,controls:false, auto:false, speed: 400,minSlides:4,maxSlides:4,slideWidth:116,moveSlides:1,slideMargin:30,
    onSlideBefore:function($slideElement, oldIndex, newIndex){},
  onSlideNext:function($slideElement, oldIndex, newIndex){},
  onSlidePrev:function($slideElement, oldIndex, newIndex){}
});
$('.ar_l').click(function(e) {e.preventDefault();slider3.goToPrevSlide();});
$('.ar_r').click(function(e) {e.preventDefault();slider3.goToNextSlide();});
  ...
  if (isMobile != true) {
   $('#pages').fullpage({
      ...
      afterLoad: function(anchorLink, index){
            ...
            if(index == 11 || index == 3 || index == 4 || index == 5 || index == 7){$('.site-nav.up').addClass('black');}else{$('.site-nav.up').removeClass('black');} 
            if(index == 3 || index == 5 || index == 7){$('.site-nav.down').addClass('black');}else{$('.site-nav.down').removeClass('black');} 
